...
export function MobileActionBar() {
  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-30 border-t border-wv-border bg-wv-black/95 sm:hidden">
      <div className="flex gap-2.5 px-4 pb-[max(0.75rem,env(safe-area-inset-bottom))] pt-3">
        <PromoCtaLink href={primaryCta.href} className={buttonClasses('primary', 'md', 'flex-1')}>
          Get Quote
        </PromoCtaLink>
        {phoneHref ? (
          <TrackedAnchor
